 ...
 */
@Data
public class VendorUpdateParam {
    ...
    @Schema(description = "绑定主账号")
    private VendorUpdateParam.AdminData AdminData;

    @Schema(description = "供应商信息")
    private VendorUpdateParam.VendorData vendorData;

    @Schema(description = "个人信息")
    private VendorUpdateParam.PersonData personData;
    ...
    public static class AdminData {
        @Schema(description = "类型 1 user；2 admin_user")
        private Integer type;
    ...
    public static class VendorData {
        ...
        private List<VendorUpdateParam.PicInfo> additionalImg;
