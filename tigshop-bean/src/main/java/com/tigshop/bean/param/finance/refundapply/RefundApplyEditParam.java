...
import static com.tigshop.common.constant.finance.RefundApplyConstants.REFUND_APPLY_ID_NOT_NULL;
...
public class RefundApplyEditParam {

    @Schema(description = "退款申请ID")
    @NotNull(message = REFUND_APPLY_ID_NOT_NULL)
