...
public class VendorDetailVO {
    ...
    private VendorDetailVO.AdminInfo adminData;

    @Schema(description = "供应商信息")
    private VendorDetailVO.VendorData vendorData;

    @Schema(description = "个人信息")
    private VendorDetailVO.PersonData personData;
    ...
    public static class VendorData {
        ...
        @Schema(description = "供应商地址(中文)")
        private String vendorAddressStr;
        ...
        private List<VendorDetailVO.PicInfo> additionalImg;
        ...
        @Schema(description = "企业名称注册地址(中文)")
        private String licenseAddrProvinceStr;
