...
import static com.tigshop.common.constant.log.StatisticsBaseConstants.STATISTICS_BASE_ID_NOT_NULL;
...
public class StatisticsBaseUpdateDTO {
    @Schema(description = "统计基础表ID")
    @NotNull(message = STATISTICS_BASE_ID_NOT_NULL)
