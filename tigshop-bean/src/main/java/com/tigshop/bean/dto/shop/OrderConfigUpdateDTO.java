...
import static com.tigshop.common.constant.shop.OrderConfigConstants.ORDER_CONFIG_ID_NOT_NULL;
...
public class OrderConfigUpdateDTO {
    @Schema(description = "订单配置ID")
    @NotNull(message = ORDER_CONFIG_ID_NOT_NULL)
