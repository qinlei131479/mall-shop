...
import static com.tigshop.common.constant.finance.OrderFinanceAftersalesConstants.ORDER_FINANCE_AFTERSALES_ID_NOT_NULL;
...
public class OrderFinanceAftersalesUpdateDTO {
    @Schema(description = "售后申请表ID")
    @NotNull(message = ORDER_FINANCE_AFTERSALES_ID_NOT_NULL)
