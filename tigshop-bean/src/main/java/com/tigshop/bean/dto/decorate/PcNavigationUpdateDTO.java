...
import static com.tigshop.common.constant.decorate.PcNavigationConstants.PC_NAVIGATION_ID_NOT_NULL;
...
public class PcNavigationUpdateDTO {
    @Schema(description = "首页分类栏ID")
    @NotNull(message = PC_NAVIGATION_ID_NOT_NULL)
    private Integer id;
