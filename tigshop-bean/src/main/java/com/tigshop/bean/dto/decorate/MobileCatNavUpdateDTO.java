...
import static com.tigshop.common.constant.decorate.MobileCatNavConstants.MOBILE_CAT_NAV_ID_NOT_NULL;
...
public class MobileCatNavUpdateDTO {
    @Schema(description = "首页分类栏ID")
    @NotNull(message = MOBILE_CAT_NAV_ID_NOT_NULL)
