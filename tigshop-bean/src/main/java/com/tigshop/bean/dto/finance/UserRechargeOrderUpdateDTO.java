...
import static com.tigshop.common.constant.finance.UserRechargeOrderConstants.USER_RECHARGE_ORDER_ID_NOT_NULL;
...
public class UserRechargeOrderUpdateDTO {
    @Schema(description = "充值记录ID")
    @NotNull(message = USER_RECHARGE_ORDER_ID_NOT_NULL)
