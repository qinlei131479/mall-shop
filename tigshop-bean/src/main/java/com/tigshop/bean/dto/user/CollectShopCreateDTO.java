...
import static com.tigshop.common.constant.user.CollectShopConstants.*;
...
public class CollectShopCreateDTO {
    ...
    @Schema(description ="会员收藏店铺的记录列表描述")
    private String collectShopDesc;
}
