...
import static com.tigshop.common.constant.setting.ShippingTplInfoConstants.SHIPPING_TPL_INFO_ID_NOT_NULL;
...
public class ShippingTplInfoUpdateDTO {
    @Schema(description = "运费模板内容ID")
    @NotNull(message = SHIPPING_TPL_INFO_ID_NOT_NULL)
