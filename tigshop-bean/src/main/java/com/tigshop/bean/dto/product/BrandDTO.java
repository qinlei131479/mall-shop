...
import static com.tigshop.common.constant.product.BrandConstants.BRAND_LENGTH_ERROR;
import static com.tigshop.common.constant.product.BrandConstants.BRAND_NAME_IS_NULL;
...
public class BrandDTO {
    ...
    @Size(min = 1, max = 30, message = BRAND_LENGTH_ERROR)
    @NotNull(message = BRAND_NAME_IS_NULL)
     ...
     */
    @Schema(description = "品牌显示顺序")
    private Integer sortOrder;

    /**
     * 该品牌是否显示;0否1显示
     */
    @Schema(description = "该品牌是否显示")
