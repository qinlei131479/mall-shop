...
import static com.tigshop.common.constant.order.AftersalesLogConstants.AFTERSALES_LOG_ID_NOT_NULL;
...
public class AftersalesLogUpdateDTO {
    @Schema(description = "售后记录ID")
    @NotNull(message = AFTERSALES_LOG_ID_NOT_NULL)
    private Integer aftersalesLogId;
