...
import static com.tigshop.common.constant.order.OrderSpitLogConstants.ORDER_SPIT_LOG_ID_NOT_NULL;
...
public class OrderSpitLogUpdateDTO {
    @Schema(description = "订单拆分ID")
    @NotNull(message = ORDER_SPIT_LOG_ID_NOT_NULL)
