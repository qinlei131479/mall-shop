            ...
            <div class="lyecs-form-table">
                <el-form v-if="!loading" ref="formRef" :rules="rules" :model="formState" label-width="auto">
                    <el-form-item prop="language" label="语言名称：" :rules="[{ required: true, message: '语言名称不能为空!' }]">
                        <TigInput classType="tig-form-input" type="text" v-model="formState.language" />
                    </el-form-item>
                    ...
                    <el-form-item prop="currencyId" label="关联货币：" :rules="[{ required: true, message: '请选择关联货币!' }]">
                        <el-select
                    ...
                    <el-form-item prop="sort" label="排序：">
                        <TigInput classType="tig-form-input" type="integer" v-model="formState.sort" />
                    </el-form-item>
...
import { getCurrencyList } from "@/api/multilingual/currencyManagement";
