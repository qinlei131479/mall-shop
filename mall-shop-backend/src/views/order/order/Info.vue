<template>
    <div v-if="!loading">
        <div class="container-card" v-if="!isParent">
            ...
            <el-space :size="10" class="button-card">
                ...
                <DialogForm
                    ...
                    @okCallback="updateDataWithList"
                    v-if="
                        (!formState.isPickup && formState.availableActions.deliver && adminType !== 'vendor' && !formState.vendorId) ||
                ...
                <DeleteRecord
                    v-if="isStore() && formState.isPickup && formState.availableActions.deliver"
                    :params="{
                    ...
                    title="该订单备货完成吗？"
                    message="备货完成"
                    @afterDelete="updateDataWithList"
                >
                    <el-button bg size="small" text type="danger"> 去备货 </el-button>
                </DeleteRecord>
                <el-button v-if="!formState.isPickup && formState.availableActions.confirmReceipt" bg size="small" text type="primary" @click="onReceiptClick">
                    确认已收货
                </el-button>
                <DialogForm
                    v-if="isStore() && formState.isPickup && formState.availableActions.confirmReceipt"
                    :params="{ act: 'detail', id: formState.orderId }"
                    :title="'订单核销 ' + formState.orderSn"
                    isDrawer
                ...
                <el-button bg size="small" text type="primary" @click="openPage(`/print/orderPrint?ids=${formState.orderId}`, 'order')"> 打印配送单 </el-button>
                <el-button v-if="formState.wayBill" bg size="small" text type="primary" @click="openPage(`/print/waybill?id=${formState.orderId}`, 'waybill')">
                    打印面单
                </el-button>
        ...
        <div class="container-card">
            ...
            <div class="info-card">
                <div class="card-title" v-if="!formState.isPickup">
                    <div class="min-title">
                        收货人信息
                        <DialogForm
                            v-if="!isParent"
                ...
                <div class="card-title" v-if="formState.isPickup">
                    ...
                    <ul>
                        ...
                        <li class="card-li" v-if="formState.pickupDetail">
                            自提点：&nbsp;&nbsp;&nbsp;&nbsp;<span class="li-info">{{ formState.pickupDetail.shopTitle }}</span>
                        </li>
                        <li class="card-li" v-if="formState.pickupDetail">
