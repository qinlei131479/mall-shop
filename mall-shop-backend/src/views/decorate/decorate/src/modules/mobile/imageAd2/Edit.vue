    ...
    <perfect-scrollbar class="decorate-edit-con">
        ...
        <div class="dec-edit-group dec-edit-group-block">
            ...
            <div class="dec-edit-group-desc">
                ...
                <div class="pic-change-desc" v-if="module.picType == 2">
        ...
        <template v-if="module.picType == 2">
            <div class="dec-edit-group">
                <div class="dec-edit-group-title">
                    <div class="label">是否显示指示器</div>
                </div>
                <div class="dec-edit-group-con">
                    <el-radio-group class="dec-radio-group" v-model="module.showIndicator">
            ...
            <template v-if="module.showIndicator == 1">
                <div class="dec-edit-group">
                    <div class="dec-edit-group-title">
