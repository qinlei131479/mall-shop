    ...
    <div class="container">
        <div class="card-row" v-loading="loading">
            <div class="card-box-row flex flex-wrap">
                    ...
                    <div class="set-box">
                        ...
                        <div class="btn-box">
                            ...
                            <DialogForm
                                ...
                                isDrawer
                                path="vendor/finance/account/Info"
                                title="编辑账户"
                                width="600px"
                ...
                <DialogForm :params="{ act: 'add' }" isDrawer path="vendor/finance/account/Info" title="添加账户" width="600px" @okCallback="loadFilter">
...
import { getAccountList, delAccount } from "@/api/vendor/capitalfund/account";
