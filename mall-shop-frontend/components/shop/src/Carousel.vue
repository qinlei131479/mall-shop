                ...
                <div class="image-ad-item">
                    <template v-for="img in item">
                        <NuxtLink
                            ...
                            :style="{ padding: module.imgPadding + 'px', width: 100 / module.swiperPreView + '%' }"
                        >
                            <el-image
                                :class="[module.picRadioStyle == 2 ? 'image-box-radius' : '']"
                                class="image-box"
...
const adjustedPicList = computed(() => {
    let pageSize = props.module.swiperPreView; // 根据type确定每页数量
