 ...
 */
public interface RefundLogService extends BaseService<RefundLog> {
    /**
     * 列表
     *
     * @param listDTO 查询参数
     * @return ListResVO
     */
    Page<RefundLogVO> list(RefundLogListDTO listDTO);
     ...
     * @return boolean
     */
    boolean create(RefundLogCreateDTO createDTO);
     ...
     * @return boolean
     */
    boolean update(RefundLogUpdateDTO updateDTO);
